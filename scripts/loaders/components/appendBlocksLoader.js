...
var AppendBlocksLoader = function (_TextLoader) {
  ...
  function AppendBlocksLoader() {
    _classCallCheck(this, AppendBlocksLoader);

    var _this = _possibleConstructorReturn(this, (AppendBlocksLoader.__proto__ || Object.getPrototypeOf(AppendBlocksLoader)).call(this));
