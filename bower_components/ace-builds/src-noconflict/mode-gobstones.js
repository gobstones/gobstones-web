...
var GobstonesHighlightRules = function() {
    ...
    var keywords = (
    "program|procedure|function|interactive|if|then|else|switch|repeat|while|foreach|in|not|div|mod|Skip|return|type|is|record|variant|field|case|matching|select|on|otherwise|choose|when|elseif|to|let"
    );
    ...
    var langClasses = (
        ...
        "minDir|maxDir|minColor|maxColor|BOOM|boom|esVacía|primero|resto|comienzo|último"
    );
