...
gulp.task('copy', function() {
  ...
  var bower = gulp.src([
    'app/bower_components/{gs-board,gs-element-blockly,blockly-package,jquery,jquery-ui,lodash,webcomponentsjs,platinum-sw,sw-toolbox,promise-polyfill,ace-builds}/**/*'
