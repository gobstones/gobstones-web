...
gulp.task('copy', function() {
  ...
  var bower = gulp.src([
    'app/bower_components/{gs-board,gobstones-interpreter,gobstones-code-runner,gs-element-blockly,blockly-package,material-walkthrough,paper-item,jquery,jquery-ui,lodash,webcomponentsjs,platinum-sw,sw-toolbox,promise-polyfill,ace-builds}/**/*'
