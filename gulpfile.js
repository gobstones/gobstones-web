...
gulp.task('copy', function() {
  ...
  var bower = gulp.src([
    'app/bower_components/{gs-board,gs-element-blockly,blockly-package,paper-item,jquery,jquery-ui,material-walkthrough,lodash,webcomponentsjs,platinum-sw,sw-toolbox,promise-polyfill,ace-builds}/**/*'
